...
ActiveRecord::Schema.define(version: 20170528175203) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string   "token"
    t.string   "waybill_file_name"
    t.string   "waybill_content_type"
    t.integer  "waybill_file_size"
    t.datetime "waybill_updated_at"
  end
